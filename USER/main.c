...
int main(void)
{
	...
	LED=0;
		...
		LCD_ShowChinese(100,0,"电子",RED,WHITE,16,0);
		...
		LCD_ShowString(10,60,"Flash:",RED,WHITE,16,0);
		LCD_ShowIntNum(55,60,Flash_Size,3,RED,WHITE,16);
		LCD_ShowString(79,60,"M!",RED,WHITE,16,0);
