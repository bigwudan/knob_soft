...
#define ST77916_QSPI_SEQ_SET_WR_L44(seq, cmd, bytes)          LCD_QSPI_SEQ_SET_WR(seq, 0x12, 1, (cmd << 8) & 0xFF00, 4, 24, 0, 0, 0, 0, 4, bytes)
...
void st77916_timseq_init(lcd_mpu_driver_t *self, lcd_mpu_cfg_t *cfg)
{
    ...
    lcd_qspi_seq_t seq;
    #define WR_CMD_DATA_VA(cmd, ...)     ST77916_WR_CMD_DATA_VA(&seq, cmd, __VA_ARGS__)
	#define WR_CMD(cmd)           ST77916_WR_CMD_SEQ(cmd, &seq, 0) 
    ...
    WR_CMD(0x11);
		...
		WR_CMD_DATA_VA(0x80, 0x11);
		WR_CMD_DATA_VA(0x81, 0x70);
		WR_CMD_DATA_VA(0x82, 0x09);
		WR_CMD_DATA_VA(0x83, 0x03);
		WR_CMD_DATA_VA(0x84, 0x20);
		WR_CMD_DATA_VA(0x89, 0x10);
		WR_CMD_DATA_VA(0x8a, 0x4f);
		WR_CMD_DATA_VA(0x8b, 0x08);
		WR_CMD_DATA_VA(0x8c, 0x59);
		WR_CMD_DATA_VA(0x8d, 0x51);
    
		WR_CMD_DATA_VA(0x36, 0x00);
    
		WR_CMD_DATA_VA(0x3a, 0x05);
		WR_CMD_DATA_VA(0xec, 0x07);
		WR_CMD_DATA_VA(0x74, 0x01, 0x80, 0x00, 0x00, 0x00, 0x00);
		WR_CMD_DATA_VA(0x98, 0x3E);
		WR_CMD_DATA_VA(0x99, 0x3E);
		WR_CMD_DATA_VA(0xC3, 0x3A);
		WR_CMD_DATA_VA(0xC4, 0x16);
		WR_CMD_DATA_VA(0xA1, 0x01, 0x04);
		WR_CMD_DATA_VA(0xA2, 0x01, 0x04);
		WR_CMD_DATA_VA(0xCB, 0x02);
		WR_CMD_DATA_VA(0x7C, 0xB6, 0x26);
		WR_CMD_DATA_VA(0xAC, 0x24);
		WR_CMD_DATA_VA(0xF6, 0x80);
		WR_CMD_DATA_VA(0xB5, 0x09, 0x09);
		WR_CMD_DATA_VA(0x60, 0x38, 0x0B, 0x5B, 0x56);
		WR_CMD_DATA_VA(0x63, 0x3A, 0xE0, 0x5B, 0x56);
		WR_CMD_DATA_VA(0x64, 0x38, 0x0D, 0x72, 0xDD, 0x5B, 0x56);
		WR_CMD_DATA_VA(0x66, 0x38, 0x11, 0x72, 0xE1, 0x5B, 0x56);
		WR_CMD_DATA_VA(0x68, 0x3B, 0x08, 0x08, 0x00, 0x08, 0x29, 0x5B);
		WR_CMD_DATA_VA(0x6E, 0x00, 0x00, 0x00, 0x07, 0x01, 0x13, 0x11, 0x0B, 0x09, 0x16, 0x15, 0x1D, 0x1E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1E, 0x1D, 0x15, 0x16, 0x0A, 0x0C, 0x12, 0x14, 0x02, 0x08, 0x00, 0x00, 0x00);	
		WR_CMD_DATA_VA(0xBE, 0x11);
		WR_CMD_DATA_VA(0x6C, 0xCC, 0x0C, 0xCC, 0x84, 0xCC, 0x04, 0x50);
		WR_CMD_DATA_VA(0x7D, 0x72);
		WR_CMD_DATA_VA(0x7E, 0x38);
		WR_CMD_DATA_VA(0x70, 0x02, 0x03, 0x09, 0x05, 0x0C, 0x06, 0x09, 0x05, 0x0C, 0x06);
		WR_CMD_DATA_VA(0x90, 0x06, 0x06, 0x05, 0x06);
		WR_CMD_DATA_VA(0x93, 0x45, 0xFF, 0x00);
		WR_CMD_DATA_VA(0xF0, 0x46, 0x0B, 0x0F, 0x0A, 0x10, 0x3F);
		WR_CMD_DATA_VA(0xF1, 0x52, 0x9A, 0x4F, 0x36, 0x37, 0xFF);
		WR_CMD_DATA_VA(0xF2, 0x46, 0x0B, 0x0F, 0x0A, 0x10, 0x3F);
		WR_CMD_DATA_VA(0xF3, 0x52, 0x9A, 0x4F, 0x36, 0x37, 0xFF);
    
		WR_CMD_DATA_VA(0x35, 0x00);
    
		WR_CMD_DATA_VA(0x44, 0x00, 0x25);
		WR_CMD_DATA_VA(0xB4, 0x0A, 0x50);
		WR_CMD_DATA_VA(0xFB, 0x00, 0x00);
